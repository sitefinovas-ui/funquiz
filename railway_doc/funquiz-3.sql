...
--
-- Hôte : localhost:8889
-- Généré le : ven. 10 oct. 2025 à 21:19
...
CREATE TABLE `achievements` (
  ...
  `badge_color` varchar(7) COLLATE utf8mb4_general_ci DEFAULT '#ffd700',
  `condition_type` enum('score','games_played','streak','perfect_score','time_spent') COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `contact` (
  ...
  `content` text COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `status` enum('operationnel','cacher') COLLATE utf8mb4_general_ci DEFAULT 'operationnel'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 2, NULL, 'Excellent quiz sur le Coupé-Décalé ! J\'ai appris des choses sur DJ Arafat 🎵', 1, '2025-09-25 07:16:28', '2025-10-07 17:35:34', 1),
(2, 4, NULL, 'Les questions sur l\'attiéké sont parfaites, ça me rappelle ma grand-mère 😊', 1, '2025-09-25 07:16:28', '2025-10-07 16:32:33', 1),
...
(7, 10, NULL, 'Parfait pour réviser notre culture ivoirienne 🇨🇮', 1, '2025-09-25 07:16:28', '2025-10-07 17:36:10', 0),
(8, 5, NULL, 'Les questions sur les marchés d\'Abidjan sont réalistes', 1, '2025-09-25 07:16:28', '2025-09-25 07:16:28', 0),
(9, 1, 6, 'Merci pour la suggestion ! Nous ajouterons bientôt plus de Zouglou', 1, '2025-09-25 07:16:28', '2025-09-25 07:16:28', 0),
...
CREATE TABLE `funquiz_messages` (
  ...
  `content_admin` text COLLATE utf8mb4_general_ci,
  ...
  `status` enum('unread','read','in_progress','resolved','closed') COLLATE utf8mb4_general_ci DEFAULT 'unread',
...
--
-- Déchargement des données de la table `funquiz_messages`
--

INSERT INTO `funquiz_messages` (`message_id`, `admin_id`, `content_admin`, `user_id`, `name`, `email`, `subject`, `content`, `priority`, `status`, `assigned_to`, `created_at`, `updated_at`) VALUES
(33, NULL, NULL, NULL, 'Ayméric Ahobaut', 'ahobautfrederick@gmail.com', 'test', 'e', 'normal', 'read', NULL, '2025-10-10 19:45:49', '2025-10-10 19:46:14');
...
(1, 12, 'freddytaylor2017@gmail.com', '2025-09-30 00:16:44', 1, '2025-10-08 18:02:24'),
(15, NULL, 'ahobautfrederick@gmail.com', '2025-10-08 16:56:34', 1, '2025-10-08 18:02:24');
...
CREATE TABLE `funquiz_users` (
  ...
  `reset_code` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `reset_expiry` datetime DEFAULT NULL,
  `is_active` tinyint(1) DEFAULT '1',
  `status` enum('active','suspended','deleted') COLLATE utf8mb4_general_ci DEFAULT 'active',
...
(2, NULL, 'Traoré', '/uploads/users/avatar-1759176910095.jpg', 'Awa Fatou', 'awa.traore@example.ci', '102030406', 0, '$2y$10$hash_awa', NULL, NULL, 1, 'active', 'user', '2025-09-25 07:16:27', '2025-10-06 23:59:04', NULL),
(3, NULL, 'Koné', NULL, 'Moussa', 'moussa.kone@example.ci', '102030407', 0, '$2y$10$hash_moussa', NULL, NULL, 1, 'active', 'moderator', '2025-09-25 07:16:27', '2025-10-06 23:59:04', NULL),
...
(5, '1234567890abcdef', 'Bamba', NULL, 'Seydou', 'seydou.bamba@example.ci', '102030409', 0, '$2y$10$hash_seydou', NULL, NULL, 1, 'active', 'user', '2025-09-25 07:16:27', '2025-10-06 23:59:04', NULL),
...
(7, NULL, 'Yao', '/uploads/users/avatar-1759176977621.jpg', 'Christian', 'christian.yao@example.ci', '102030411', 0, '$2y$10$hash_christian', NULL, NULL, 1, 'suspended', 'user', '2025-09-25 07:16:27', '2025-10-07 00:13:15', NULL),
...
(11, NULL, 'Ahobaut', '/uploads/users/avatar-1759178474108.webp', 'Ayméric', 'ahobautfrederick@gmail.com', '33610694708', 1, '$2b$10$nFXllRl2.NU5wjkgCrmT9u1Wq0KdnkqI1UFfawFevpu4/iYkwNJei', NULL, NULL, 1, 'active', 'admin', '2025-09-25 08:21:07', '2025-10-10 19:50:13', '2025-10-10 21:50:14'),
(12, '110748433686325263462', 'Freddy Taylor', 'https://lh3.googleusercontent.com/a/ACg8ocIaJFFInQvPVTF7sURmin6gmKu1g1Xj3NGaNqG0DjVN_ikkHGyAqg=s96-c', 'Frédérick', 'freddytaylor2017@gmail.com', '0', 0, NULL, NULL, NULL, 1, 'active', 'admin', '2025-09-25 15:18:33', '2025-10-06 23:59:42', NULL),
...
(31, NULL, 'Rosine', NULL, 'Wadja', 'rosinewadja@gmail.com', NULL, 0, '$2b$10$XTK4iQxWXXnWTDhe4ngs0u.ls.VVffpIZMWk0OQ.pYHqhRv1V39VO', NULL, NULL, 1, 'active', 'admin', '2025-10-06 21:39:06', '2025-10-06 23:59:42', '2025-10-06 23:39:07'),
(36, NULL, 'imane', NULL, 'hochti', 'aaahobaut@gmail.com', '222222222', 0, '$2b$10$w9fJ3hDfN/e4xK83cgtzietzWQ6sEe/VRM.LZIHPUzM7E3hwao6we', NULL, NULL, 0, 'suspended', 'user', '2025-10-10 03:44:12', '2025-10-10 03:55:29', '2025-10-10 05:44:13'),
(37, NULL, 'a', NULL, 'b', 'uuu@gmail.com', '1234567890', 0, '$2b$10$1x/WdPeafrjgRB9cONmZQuT5NGUXJc6u5WhGLwlgk857bnBh2ZWwG', NULL, NULL, 1, 'active', 'user', '2025-10-10 04:14:47', '2025-10-10 04:14:47', '2025-10-10 06:14:47');
...
INSERT INTO `publicite` (`id`, `titre`, `description`, `image_url`, `date_debut`, `date_fin`, `statut`, `type`, `clics`, `created_at`, `updated_at`) VALUES
(1, 'Découvre FunQuiz – Apprends en t’amusant !', 'Teste ta culture générale à travers des quiz variés et amusants 🎉. \n    Chaque question t’aide à apprendre quelque chose de nouveau, dans un univers coloré et interactif. \n    Parfait pour passer un bon moment seul ou entre amis !', 'https://th.bing.com/th/id/OIP.ygH_HKRZPDTi9EPfxnO1HwHaEK?w=291&h=181&c=7&r=0&o=7&dpr=2&pid=1.7&rm=3', '2025-10-10', '2025-10-30', 'actif', 'image', 0, '2025-10-10 18:06:03', '2025-10-10 19:30:02');
...
CREATE TABLE `quiz_answers` (
  ...
  `answer_option1` text COLLATE utf8mb4_general_ci NOT NULL,
  `answer_option2` text COLLATE utf8mb4_general_ci NOT NULL,
  `answer_option3` text COLLATE utf8mb4_general_ci NOT NULL,
  `correct_option` tinyint NOT NULL,
  `answer_type` enum('text','image','audio','video') COLLATE utf8mb4_general_ci DEFAULT 'text',
...
CREATE TABLE `quiz_game_history` (
  ...
  `difficulty_level` enum('facile','moyen','difficile') COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `quiz_questions` (
  ...
  `difficulty_level` enum('facile','moyen','difficile') COLLATE utf8mb4_general_ci DEFAULT 'moyen',
  `question_type` enum('multiple_choice','single_choice','true_false','text_input') COLLATE utf8mb4_general_ci DEFAULT 'multiple_choice',
...
CREATE TABLE `quiz_thematics` (
  ...
  `description` text COLLATE utf8mb4_general_ci,
  `icon_url` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `color_code` varchar(7) COLLATE utf8mb4_general_ci DEFAULT '#6366f1',
  `is_active` tinyint(1) DEFAULT '1',
  `display_order` int DEFAULT '0',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
...
(30, 'Mathématiques', 'Questions de logique et de calcul', NULL, '#4CAF50', 1, 1, '2025-10-10 11:12:51', '2025-10-10 11:12:51');
...
(8, 11, 30, 51, 1, '[]', 1, 0, 4, NULL, '2025-10-10 12:14:18', '2025-10-10 13:52:29', 0, '{\"subTitle\": \"Algèbre\", \"thematicTitle\": \"Mathématiques\"}'),
...
--
-- Déchargement des données de la table `user_totals_link`
--

INSERT INTO `user_totals_link` (`link_id`, `user_id`, `total_id`, `created_at`) VALUES
(1, 1, 10, '2025-09-27 10:37:10'),
(2, 2, 1, '2025-09-27 10:37:10'),
(3, 3, 12, '2025-09-27 10:37:10'),
(4, 4, 2, '2025-09-27 10:37:10'),
(5, 5, 3, '2025-09-27 10:37:10'),
(6, 6, 4, '2025-09-27 10:37:10'),
(7, 7, 5, '2025-09-27 10:37:10'),
(8, 8, 6, '2025-09-27 10:37:10'),
(9, 9, 7, '2025-09-27 10:37:10'),
(10, 10, 8, '2025-09-27 10:37:10'),
(11, 11, 11, '2025-09-27 10:37:10'),
(12, 12, 9, '2025-09-27 10:37:10');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `user_points`  AS SELECT `u`.`user_id` AS `user_id`, `u`.`name` AS `name`, `u`.`first_name` AS `first_name`, concat(`u`.`first_name`,' ',`u`.`name`) AS `full_name`, `u`.`email` AS `email`, coalesce(sum(`gh`.`score`),0) AS `total_points_games`, coalesce(sum(`a`.`points_reward`),0) AS `total_points_achievements`, (coalesce(sum(`gh`.`score`),0) + coalesce(sum(`a`.`points_reward`),0)) AS `total_points`, count(distinct `gh`.`history_id`) AS `total_games_played`, count(distinct `ua`.`achievement_id`) AS `total_achievements`, coalesce(avg(`gh`.`completion_percentage`),0) AS `average_completion` FROM (((`funquiz_users` `u` left join `quiz_game_history` `gh` on((`u`.`user_id` = `gh`.`user_id`))) left join `quiz_user_achievements` `ua` on((`u`.`user_id` = `ua`.`user_id`))) left join `achievements` `a` on((`ua`.`achievement_id` = `a`.`achievement_id`))) WHERE (`u`.`is_active` = true) GROUP BY `u`.`user_id`, `u`.`name`, `u`.`first_name`, `u`.`email` ;
...
--
-- Index pour la table `cookies_policy`
--
...
--
-- Index pour la table `funquiz_faq`
--
ALTER TABLE `funquiz_faq`
  ADD PRIMARY KEY (`faq_id`);

--
-- Index pour la table `funquiz_messages`
--
ALTER TABLE `funquiz_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `assigned_to` (`assigned_to`),
  ADD KEY `idx_status` (`status`),
  ADD KEY `idx_priority` (`priority`),
  ADD KEY `fk_fun_admin` (`admin_id`);
...
--
-- Index pour la table `funquiz_users`
--
ALTER TABLE `funquiz_users`
...
--
-- Index pour la table `quiz_game_history`
--
ALTER TABLE `quiz_game_history`
  ADD PRIMARY KEY (`history_id`),
  ADD KEY `sub_thematic_id` (`sub_thematic_id`),
  ADD KEY `idx_user` (`user_id`),
...
ALTER TABLE `quiz_questions`
  ...
  ADD KEY `idx_sub_thematic` (`sub_thematic_id`),
  ADD KEY `idx_type` (`question_type`),
  ADD KEY `idx_active` (`is_active`);

--
-- Index pour la table `quiz_sub_thematics`
--
ALTER TABLE `quiz_sub_thematics`
  ADD PRIMARY KEY (`sub_thematic_id`),
  ADD KEY `idx_thematic` (`thematic_id`),
  ADD KEY `idx_difficulty` (`difficulty_level`);

--
-- Index pour la table `quiz_thematics`
--
ALTER TABLE `quiz_thematics`
  ADD PRIMARY KEY (`thematic_id`),
  ADD KEY `idx_active_order` (`is_active`,`display_order`);

--
-- Index pour la table `quiz_user_achievements`
--
ALTER TABLE `quiz_user_achievements`
...
--
-- Index pour la table `quiz_user_sessions`
--
ALTER TABLE `quiz_user_sessions`
  ADD PRIMARY KEY (`session_id`),
  ADD KEY `idx_user_session` (`user_id`,`is_completed`),
  ADD KEY `idx_thematic` (`thematic_id`),
  ADD KEY `idx_sub_thematic` (`sub_thematic_id`);

--
-- Index pour la table `quiz_user_totals`
--
ALTER TABLE `quiz_user_totals`
  ADD PRIMARY KEY (`total_id`),
  ADD UNIQUE KEY `user_id` (`user_id`);

--
-- Index pour la table `user_feedbacks`
--
...
--
-- Index pour la table `user_totals_link`
--
ALTER TABLE `user_totals_link`
  ADD PRIMARY KEY (`link_id`),
  ADD UNIQUE KEY `unique_user_total` (`user_id`,`total_id`),
  ADD KEY `fk_user_totals_link_total` (`total_id`);
...
--
ALTER TABLE `achievements`
  MODIFY `achievement_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
-- AUTO_INCREMENT pour la table `cookies_policy`
--
ALTER TABLE `cookies_policy`
...
--
-- AUTO_INCREMENT pour la table `funquiz_faq`
--
ALTER TABLE `funquiz_faq`
  MODIFY `faq_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT pour la table `funquiz_messages`
--
ALTER TABLE `funquiz_messages`
  MODIFY `message_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT pour la table `funquiz_newsletter`
--
ALTER TABLE `funquiz_newsletter`
  MODIFY `newsletter_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT pour la table `funquiz_users`
--
ALTER TABLE `funquiz_users`
...
--
-- AUTO_INCREMENT pour la table `quiz_game_history`
--
ALTER TABLE `quiz_game_history`
...
--
ALTER TABLE `quiz_questions`
  MODIFY `question_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;

--
-- AUTO_INCREMENT pour la table `quiz_sub_thematics`
--
ALTER TABLE `quiz_sub_thematics`
  MODIFY `sub_thematic_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;

--
-- AUTO_INCREMENT pour la table `quiz_thematics`
--
ALTER TABLE `quiz_thematics`
  MODIFY `thematic_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT pour la table `quiz_user_achievements`
--
ALTER TABLE `quiz_user_achievements`
  MODIFY `user_achievement_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;

--
-- AUTO_INCREMENT pour la table `quiz_user_sessions`
--
ALTER TABLE `quiz_user_sessions`
  MODIFY `session_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT pour la table `quiz_user_totals`
--
ALTER TABLE `quiz_user_totals`
  MODIFY `total_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT pour la table `user_feedbacks`
--
ALTER TABLE `user_feedbacks`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT pour la table `user_totals_link`
--
ALTER TABLE `user_totals_link`
...
--
-- Contraintes pour la table `funquiz_comments`
--
ALTER TABLE `funquiz_comments`
  ADD CONSTRAINT `funquiz_comments_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `funquiz_users` (`user_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `funquiz_comments_ibfk_2` FOREIGN KEY (`parent_comment_id`) REFERENCES `funquiz_comments` (`comment_id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `funquiz_messages`
--
ALTER TABLE `funquiz_messages`
  ADD CONSTRAINT `fk_fun_admin` FOREIGN KEY (`admin_id`) REFERENCES `funquiz_users` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `funquiz_messages_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `funquiz_users` (`user_id`) ON DELETE SET NULL,
  ADD CONSTRAINT `funquiz_messages_ibfk_2` FOREIGN KEY (`assigned_to`) REFERENCES `funquiz_users` (`user_id`) ON DELETE SET NULL;

--
-- Contraintes pour la table `funquiz_newsletter`
--
ALTER TABLE `funquiz_newsletter`
  ADD CONSTRAINT `funquiz_newsletter_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `funquiz_users` (`user_id`);
...
--
-- Contraintes pour la table `quiz_game_history`
--
ALTER TABLE `quiz_game_history`
  ADD CONSTRAINT `quiz_game_history_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `funquiz_users` (`user_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `quiz_game_history_ibfk_2` FOREIGN KEY (`sub_thematic_id`) REFERENCES `quiz_sub_thematics` (`sub_thematic_id`) ON DELETE SET NULL;

--
-- Contraintes pour la table `quiz_questions`
--
ALTER TABLE `quiz_questions`
  ADD CONSTRAINT `quiz_questions_ibfk_1` FOREIGN KEY (`sub_thematic_id`) REFERENCES `quiz_sub_thematics` (`sub_thematic_id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `quiz_sub_thematics`
--
ALTER TABLE `quiz_sub_thematics`
  ADD CONSTRAINT `quiz_sub_thematics_ibfk_1` FOREIGN KEY (`thematic_id`) REFERENCES `quiz_thematics` (`thematic_id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `quiz_user_achievements`
--
ALTER TABLE `quiz_user_achievements`
  ADD CONSTRAINT `quiz_user_achievements_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `funquiz_users` (`user_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `quiz_user_achievements_ibfk_2` FOREIGN KEY (`achievement_id`) REFERENCES `achievements` (`achievement_id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `quiz_user_sessions`
--
ALTER TABLE `quiz_user_sessions`
  ADD CONSTRAINT `fk_session_sub_thematic` FOREIGN KEY (`sub_thematic_id`) REFERENCES `quiz_sub_thematics` (`sub_thematic_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_session_thematic` FOREIGN KEY (`thematic_id`) REFERENCES `quiz_thematics` (`thematic_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_session_user` FOREIGN KEY (`user_id`) REFERENCES `funquiz_users` (`user_id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `quiz_user_totals`
--
ALTER TABLE `quiz_user_totals`
  ADD CONSTRAINT `fk_quiz_user_totals_user` FOREIGN KEY (`user_id`) REFERENCES `funquiz_users` (`user_id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `user_feedbacks`
--
ALTER TABLE `user_feedbacks`
  ADD CONSTRAINT `user_feedbacks_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `funquiz_users` (`user_id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `user_totals_link`
--
ALTER TABLE `user_totals_link`
  ADD CONSTRAINT `fk_user_totals_link_total` FOREIGN KEY (`total_id`) REFERENCES `quiz_user_totals` (`total_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_user_totals_link_user` FOREIGN KEY (`user_id`) REFERENCES `funquiz_users` (`user_id`) ON DELETE CASCADE;
COMMIT;

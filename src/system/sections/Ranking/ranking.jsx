    ...
    <div className="w-100 h-100 mb-5 overflow-hidden">
      ...
      >
        ...
        <div className="container d-flex w-50 flex-column align-items-center justify-content-center">
          ...
          <p className="text-muted-custom-desk text-center">
            Retrouvez ici le classement des meilleurs joueurs, mis à jour en
            temps réel en fonction de leurs performances.
          </p>
        </div>
        <img
          src={userRaking}
      ...
      <div className="ranking-content gap-4 w-100 d-flex align-items-center justify-content-center">
        ...
        <div  className="j-2 align-items-center justify-content-center d-flex flex-column">
          <div style={{width:'190px', height:'190px'}} className="user-animation rounded-circle overflow-hidden">
            <img
        ...
        <div className="position-relative">
          ...
          <div className="card-cus-raking align-items-center justify-content-center mx-3 d-flex flex-column">
            <div style={{width:'230px', height:'230px'}} className="user-animation bg-success j-1 rounded-circle overflow-hidden b-2">
              <img
      ...
      >
        {rankingData.slice(3).map((rank, index) => (
          ...
          >
            ...
            <span className="fw-bold text-white score">
              {rank.total_points} 🪙
            </span>
          </div>
        ))} 
